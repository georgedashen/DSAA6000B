...
def train(model, g, args):
    ...
    stats.append(
        {
            'hid_dim': args.hid_dim, #D
            'n_layer': args.n_layer, #L
            'EPOCH': args.epoch,
    ...
    filename = args.output + '/' + 'stat_' + 'L' + str(args.n_layer) + '_D' + str(args.hid_dim) + '_Epoch' + str(args.epoch) + '.csv'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output", type=str, default='./results', help="Output best metrics")
